...
fn test_did_register_and_resolve() {
    ...
    doc.add_verification_method(VerificationMethod { id: "vm1".into(), type_: "Ed25519VerificationKey2018".into(), public_key: vec![1,2,3] });
    reg.register(doc);
...
fn test_recovery_flow() {
    ...
    rm.add_agent(identity::recovery::RecoveryAgent { id: "agent1".into(), contact: "agent@example.com".into() });
